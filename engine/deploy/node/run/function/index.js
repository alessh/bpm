...
var node_func = function(RED = {}) {
    ...
    var n = new node();
    var func = FunctionNode.bind(n, {name: 'function', topic: '', func: 'console.log(msg.payload.mensagem);'})

    func();

    n.emit('input', { _msgid: '123131', payload: { mensagem: 'funciona !!!!'}});
}
